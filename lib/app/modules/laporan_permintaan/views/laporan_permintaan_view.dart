...
class LaporanPermintaanView extends GetView<LaporanPermintaanController> {
  // ignore: use_key_in_widget_constructors
  const LaporanPermintaanView({Key? key});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              // Apply some styling to the elevated button
              ElevatedButton(
                onPressed: () {
                  controller
                      .createLaporanPermintaan(controller.isiController.text);
                  Get.back();
                },
